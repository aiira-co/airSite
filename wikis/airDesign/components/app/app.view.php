<ad-section class="bg-dark" style="margin-top:-8px !important;  min-height:250px; background-image:url('<?=BaseUrl;?>media/images/bg-lines.png'); background-size:cover; background-position:center;">
  <ad-wrapper>
    <ad-row>
      <div class="ad-cols-12">
        <div class="ad-card ad-block ad-flat text-center" >
          <?php CORE::component('homeslider');?>
        </div>
      </div>
    </ad-row>
  </ad-wrapper>
...
<ad-section class="bg-white iphone-x idark">
  <ad-wrapper>
    <ad-row>
    <div class="ad-cols-12">
...
<br>
      ...
      <div class="ad-row" style="font-size:17px;">
...
<ad-section class="bg-white ">
  ...
  <div class="ad-cols-4">
    <div class="ad-card ad-flat">
      ...
      <div class="ad-cols-8">
        <div class="ad-card ad-flat" style="font-size:17px;">
        <p>
        ...
        <p>
          ...
          <pre class="ad-code">
            <code>
              ...
              <span class="id">@import</span>: <span class="class">url(</span><span class="word">'assets/css/air.design.css'</span><span class="class">)</span>;
    ...
    <div class="ad-cols-8 doc" style="font-size:17px;">
      ...
      <pre class="ad-code">
        <code>
                ...
                <span class="id">font-family</span>: <span class="word">bariol</span>;

                <span class="id">font-size</span>: <span class="word">14px</span>;

                <span class="id">background-color</span>: <span class="word">whitesmoke</span>;
...
<ad-section class="bg-dark">
  <div class="wrapper">
    ...
    <div class="ad-row">
        ...
        <div class="ad-card ">
          ...
          <div class="ad-list ad-hover hover-tgreen">
            <div class="ad-avatar ad-button">
              <img src="<?=BaseUrl;?>media/images/users/user1.jpg" alt="">
      ...
      <div class="ad-cols-4">
        <div class="ad-card ">
        <img src="<?=BaseUrl;?>media/images/bg.jpg" class="img-responsive"  alt="">
          <div class="ad-user" style="position:absolute; left:50%; margin-left:-50px; margin-top:-50px;">
            <img src="<?=BaseUrl;?>media/images/users/user1.jpg" class="img-responsive"  alt="">
          </div>
  ...
  <ad-wrapper>
    <ad-row>
      <div class="ad-colx-12">
        <button type="button" name="button" routerLink="<?=BaseUrl;?>headers_navs" class="ad-btn ad-flat ad-round ad-md btn-blue  rFloat">Headers & Navigations &nbsp; <i class="fa fa-angle-right"></i></button>
      </div>
    </ad-row>
  </ad-wrapper>
</ad-section>
